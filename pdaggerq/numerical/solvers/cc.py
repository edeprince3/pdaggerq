...
from pdaggerq.numerical.utils.psi4_integrals import get_integrals
from pdaggerq.numerical.utils.psi4_integrals import get_integrals_with_spin
...
class cc:
    ...
    def __init__(self, wfn, 
        ...
        if not self.is_qed:
            ...
            from pdaggerq.numerical.utils.psi4_integrals import get_quadrupole_integrals_with_spin
