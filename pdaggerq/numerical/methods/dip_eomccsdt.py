...
class DIP_EOMCCSDT:
    ...
    def right_solver(self):
        ...
        r3 = {
            'spaces' : ['v', 'ooo'],
            'spins' : [['a', 'aaa'], ['a','aab'], ['b', 'aab'], ['a', 'abb'], ['b', 'abb'], ['b', 'bbb']],
            'sigma' : local_namespace["right_sigma3"]
        }
        r4 = {
            'spaces' : ['vv', 'oooo'],
            'spins' : [['aa', 'aaaa'], ['aa','aaab'], ['ab', 'aaab'], ['aa', 'aabb'], ['ab', 'aabb'], ['bb', 'aabb'], ['ab', 'abbb'], ['bb', 'abbb'], ['bb', 'bbbb']],
    ...
    def oscillator_strengths(self):
        raise Exception("oscillator strengths are not implemented for DIP-EOMCCSDT")
