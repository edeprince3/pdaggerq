...
class pq_helper {
  ...
  public:
     ...
     *     excitation level of the whole sandwich can be zero. Cluster amplitudes
     *     and explicit e<n>(...) operators carry a fixed level; the Hamiltonian
     *     pieces carry a range.
     *
