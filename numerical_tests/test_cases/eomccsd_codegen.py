...
def eomcc_sigma(residual_name, t_ops, l_ops, function_name):
...
def main():
    ...
    eomcc_sigma('sigma0', ['t1', 't2'], [['1']], 'right_sigma0')
    eomcc_sigma('sigma1', ['t1', 't2'], [['e1(i,a)']], 'right_sigma1')
    eomcc_sigma('sigma2', ['t1', 't2'], [['e2(i,j,b,a)']], 'right_sigma2')
